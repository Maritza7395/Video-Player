...
function queries() {
    ...
    $("#player").mouseenter(function() { $('#row-btns').css('display', 'block'); $('.progreso').css('display', 'block'); });
    $("#player").mouseleave(function() { $('#row-btns').css('display', 'none'); $('.progreso').css('display', 'none'); });
}
